...
<head>
    ...
    <!--TITULO--><title>UASD - Educacion permanente</title>
...
<section>
    ...
    <div class="leftpanel">
        ...
        <div class="logopanel">
            <h1><span>[</span> EP - UASD <span>]</span></h1>
        </div><!-- logopanel -->
        ...
        <div class="leftpanelinner">
            ...
            <ul class="nav nav-pills nav-stacked nav-bracket ">
                ...
                <li  class="nav-parent"><a href="<?php echo base_url() ?>#"><i class="fa fa-user"></i> <span>Egresados</span></a>
                         <ul class="children" >
                            <li><a href="<?=base_url()?>investigadores/nuevo_investigador">Registrar Egresado</a></li>
                            <li><a href="<?=base_url()?>#">Egresados por Facultad</a></li>
                            <li><a href="<?=base_url()?>egresados/index">Lista de  Egresados</a></li>
                        </ul>
                </li>

                 <li class="nav-parent"><a href="<?php echo base_url() ?>#"><i class="fa fa-edit"></i> <span>Diplomados</span></a>

                                <ul class="children">                                    
                                    <li><a href="<?=base_url()?>#">Registrar Diplomado</a></li>
                                    <li><a href="<?=base_url()?>#">Lista de Diplomados</a></li>
                                </ul>
                </li>

                 <li class="nav-parent"><a href="<?php echo base_url()?>#"><i class="fa fa-edit"></i> <span>Cursos</span></a>
                            <ul class="children">
                                <li><a href="<?=base_url()?>#">Registrar Curso</a></li>                                
                                <li><a href="<?=base_url()?>#">Lista de Cursos</a></li>
                            </ul>
                 </li>


                 <li class="nav-parent"><a href="<?php echo base_url()?>#"><i class="fa fa-bell"></i> <span>Habilitación docente</span></a>
                            <ul class="children">
                                <li><a href="<?=base_url()?>#">Registrar Habilitacion</a></li>
                                <li><a href="<?=base_url()?>#">Lista de Habilitacion</a></li>
                            </ul>
                </li>

                <li class="nav-parent"><a href="<?php echo base_url()?>#"><i class="fa fa-bell"></i> <span>Seminarios</span></a>
                            <ul class="children">
                                <li><a href="<?=base_url()?>#">Registrar Seminario</a></li>
                                <li><a href="<?=base_url()?>#">Lista de Seminarios</a></li>
                            </ul>
                </li>

                <li class="nav-parent"><a href="<?php echo base_url()?>#"><i class="fa fa-bell"></i> <span>Talleres</span></a>
                            <ul class="children">
                                <li><a href="<?=base_url()?>#">Registrar Taller</a></li>
                                <li><a href="<?=base_url()?>#">Lista de Talleres</a></li>
                            </ul>
                </li>
