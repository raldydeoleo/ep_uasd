        ...
        <div class="col-md-12">
            <div class="panel-primary">
                <div class="panel-heading">
                    <h4 class="panel-title">Registro de Egresado</h4>
                </div>
            </div>

<?=form_open(base_url().'egresados/insertar_egresado');
...
?>
                           ...
                           <div class="form-group">
                               <div class="col-md-8">
                               <div> <a class="btn btn-success" href="<?php echo base_url() ?>index.php/egresados/listaEgresados"> Ver Listado </a> </div>
