...
<head>
  ...
  <title>EDUCACION PERMANENTE - UASD</title>
        ...
        <img alt="logouasd" src="<?=base_url()?>uploads/logo.jpg" width="165" height="150" class="media-object">
            ...
            <div class="col-md-7">
                ...
                <div class="signin-info">
                    <div class="logopanel">
                    <h1><span>[</span> EDUCACION PERMANENTE <span>]</span></h1><br>
                    ...
                    <ul>
                        <li><i class="fa fa-arrow-circle-o-right mr5"></i> Egresados</li>
                        <li><i class="fa fa-arrow-circle-o-right mr5"></i> Diplomados</li>
                        <li><i class="fa fa-arrow-circle-o-right mr5"></i> Cursos</li>
                        <li><i class="fa fa-arrow-circle-o-right mr5"></i> Habilitacion docente</li>
                        <li><i class="fa fa-arrow-circle-o-right mr5"></i> Talleres</li>
                        <li><i class="fa fa-arrow-circle-o-right mr5"></i> Seminarios</li>
