 ...
 * Controlador que maneja la logica de todos los procesos de la entidad egresados.
 * 12-09-2018
**/
class Egresados extends CI_Controller {
    ...
    public function listaEgresados(){
        ...
        $this->mostrarVista('panel/secretaria/listaEgresados');
    }


    public function nuevo_egresado()
    {   $this->load->model('estudiantes_model');
        //$estudiantes = $this->estudiantes_model->obtener_todos();
        //$this->asignarDatosVista('estudiantes', $estudiantes);
        $this->mostrarVista('panel/secretaria/crear_egresado');
