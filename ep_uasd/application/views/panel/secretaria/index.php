...
<a href="#" class="pull-right">
    ...
    <h2>Educacion permanente</h2> 
    <h3>Lista de egresados</h3> <h4 class="panel-title">Búsqueda por criterios</h4>
    ...
    <div class="form-group">
        ...
        <div class="col-md-2"> <a class="btn btn-primary" href="<?php echo base_url() ?>index.php/dashboards/mostrar"> Panel principal </a> </div>
                <div class="col-md-2"> <a class="btn btn-warning" href="<?php echo base_url() ?>index.php/egresados/"> Volver al listado </a> </div>
