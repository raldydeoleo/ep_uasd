...
<div class="col-md-8">
    ...
    <div class="panel-heading">
        ...
        <h5 class="panel-title"> Actualizar datos del Egresado </h1>
    </div>
    ...
    <form method="post" action="<?php echo base_url() ?>/investigadores/guardar_post/<?php  echo $id_estudiante ?>">
      ...
      <div class="col-md-4">
        ...
        <div class="col-md-9"><a class="btn btn-danger" href="<?php echo base_url() ?>index.php/egresados/index">Cancelar</a></div>
